...
class TestXpathSelector(TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_sel_list_number_does_not_exist(self):
        ...
        self.assertRaises(SelectionNotFoundError, sel.number)
    ...
    def test_attr_does_not_exist(self):
        root = XpathSelector(self.tree)
        self.assertRaises(
            SelectionNotFoundError, lambda: root.select("//ul[1]").attr("id-xxx")
        )
...
class TestXpathSelectorList(TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_one_default(self):
        ...
        self.assertRaises(SelectionNotFoundError, sel.one)
    ...
    def test_node_default(self):
        sel = XpathSelector(self.tree).select("//ul/li[10]")
        self.assertRaises(SelectionNotFoundError, sel.node)
    ...
    def test_text_default(self):
        sel = XpathSelector(self.tree).select("//ul/li[10]")
        self.assertRaises(SelectionNotFoundError, sel.text)
    ...
    def test_html_default(self):
        sel = XpathSelector(self.tree).select("//ul/li[10]")
        self.assertRaises(SelectionNotFoundError, sel.html)
    ...
    def test_inner_html_default(self):
        sel = XpathSelector(self.tree).select("//ul/li[10]")
        self.assertRaises(SelectionNotFoundError, sel.inner_html)
    ...
    def test_attr_default(self):
        ...
        self.assertRaises(SelectionNotFoundError, lambda: sel.attr("class"))
    ...
    def test_rex_default(self):
        sel = XpathSelector(self.tree).select("//ul/li[10]")
        self.assertRaises(SelectionNotFoundError, lambda: sel.rex("zz"))
    ...
    def test_require(self):
        ...
        self.assertRaises(
            SelectionNotFoundError, XpathSelector(self.tree).select("//foo").require
        )
...
class RexResultListTestCase(TestCase):
    ...
    def test_text_no_default(self):
        sel = XpathSelector(self.tree).select("//ul/li/text()")
        self.assertRaises(SelectionNotFoundError, lambda: sel.rex("(zz)").text())
